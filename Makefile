all:
	g++ atm.cpp util.cpp -m64 -o atm -lcryptopp
...
32:
	g++ atm.cpp util.cpp -m32 -o atm -lcryptopp
...
debug:
	g++ atm.cpp util.cpp -g -m64 -o atm -lcryptopp
...
debug32:
	g++ atm.cpp util.cpp -g -m32 -o atm -lcryptopp
